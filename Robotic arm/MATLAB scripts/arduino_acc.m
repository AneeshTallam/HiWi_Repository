...
flush(serialObj);
serialObj.UserData = struct("Data", [NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN],"Time", ['00-00_00'], "Count",1);

maxDataPoints = 20000;
configureCallback(serialObj, "terminator", @(src,event) catcher_acc(src,event,maxDataPoints))

%configureCallback(serialObj, "terminator", @(src,event) catcher_acc(src,event,0))
