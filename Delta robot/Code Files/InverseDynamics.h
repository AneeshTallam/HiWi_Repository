...
#ifndef _INVERSE_DYNAMICS_H_

#define _INVERSE_DYNAMICS_H_

#include "scSubModel.h"
#include "scVector.h"
#include "scSpatial.h"

class InverseDynamics : public scSubModel {
...
private:
	...
	V_REAL64 mass_forearm;
	V_REAL64 mass_upper_arm;
	V_REAL64 inertia_dominant_forearm;
	V_REAL64 inertia_motor;
	V_REAL64 inertia_upper_arm;
